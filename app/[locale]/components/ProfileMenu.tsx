    ...
    <div className="relative flex items-center gap-3">
      ...
      {user ? (
        <div className="flex items-center gap-2">
          <button type="button" onClick={() => setIsOpen((prev) => !prev)} className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-indigo-100 text-indigo-700 font-medium hover:bg-indigo-200 focus:outline-none" aria-label="Profil utilisateur">
